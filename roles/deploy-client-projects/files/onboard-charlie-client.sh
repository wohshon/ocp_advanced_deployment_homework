...
oc process multitenant-project-request -p PROJECT_DESCRIPTION='' -p PROJECT_DISPLAYNAME='' -p PROJECT_NAME='charlie' -p PROJECT_ADMIN_USER='candy' -p GROUP_NAME=charlie-users -p CLIENT_NODE_SELECTOR='client=common' | oc create -f -
